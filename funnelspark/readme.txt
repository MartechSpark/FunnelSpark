...
3. Go to **FunnelSpark → Settings** and enter your GA4 Property ID and Service Account JSON
...
4. Download the **JSON key file** and paste its contents into FunnelSpark → Settings
5. In GA4 → Admin → Account Access Management → add the service account email as **Viewer**
6. Copy your **GA4 Property ID** from GA4 → Admin → Property Settings
...
= 1.0.0 =
Initial release of FunnelSpark.
